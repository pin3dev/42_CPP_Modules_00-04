...
/*   Updated: 2024/01/25 14:16:02 by pin3dev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout <<  BKGRAY "[ANIMAL] Copy constructor called to "  << this->getType() + RESET << std::endl;
}
...
{
	std::cout <<  RED "[ANIMAL] some sound..." RESET << std::endl;
}